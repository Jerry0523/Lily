...
public class LilyActivity extends Activity implements OnClickListener,OnPageChangeListener, OnCheckedChangeListener{
	...
	private Handler mHandler = new Handler(){ 
		...
		public void handleMessage(Message msg) {
			...
			if(msg.arg1 == 1) {
				Toast.makeText(LilyActivity.this, "ÍøÂçÒì³££¬ÇëÉÔºóÔÙÊÔ!", Toast.LENGTH_SHORT).show();
	...
	private View initBorardView() {
		...
		SimpleEditAdapter boardAdapter = new SimpleEditAdapter(this, R.layout.list_edit_item, R.id.list_textview, R.id.list_select, R.id.list_delete, favList) {
			...
			protected void onDelete(final int position) {
				...
				new IOSAlertDialog.Builder(LilyActivity.this).setTitle("×¢Òâ").setMessage("¼´½«É¾³ý" + getItem(position) + '\n' + "ÊÇ·ñ¼ÌÐø?").setPositiveButton("¼ÌÐø", listener).create().show();
			}
		};
