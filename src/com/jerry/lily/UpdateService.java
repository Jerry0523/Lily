...
public class UpdateService extends Service{
	...
	public int onStartCommand(Intent intent,int flags,int startId){
		...
		PendingIntent contentIntent = PendingIntent.getActivity(this,0,new Intent(this,Welcome.class),0);
	...
	private void downFile() {
		final String url = "http://bbs.nju.edu.cn/file/W/WStaotao/Lily.apk";
		new Thread() {
			public void run(){
				try {     
					...
					if (is !=  null) {
						tempFile  =  new File(FileDealer.getUpdateDirPath() + "/Lily.apk");
						if(tempFile.exists())
							tempFile.delete();
