	...
	private void initComponents() {
		...
		send2Me.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(Set.this, Send2Me.class);
		...
		isLogin.addChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				DatabaseDealer.updateSettings(Set.this, "isLogin", isChecked ? "1" : "0");
			}
		});
		...
		isNight.addChangeListener(new OnCheckedChangeListener() {
			...
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				DatabaseDealer.updateSettings(Set.this, "isNight", isChecked ? "1" : "0");
				Intent intent = new Intent(Set.this, Welcome.class);
				startActivity(intent);
				overridePendingTransition(R.anim.slide_right_in, R.anim.slide_left_out);
			}
		});
		...
		isReplyMail.addChangeListener(new OnCheckedChangeListener() {
			...
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				DatabaseDealer.updateSettings(Set.this, "isSendMail", isChecked ? "1" : "0");
			}
		});
		...
		isShowPic.addChangeListener(new OnCheckedChangeListener() {
			...
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				DatabaseDealer.updateSettings(Set.this, "isShowPic", isChecked ? "1" : "0");
			}
		});
		...
		small.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				DatabaseDealer.updateSettings(Set.this, "fontSize", "15");
			}
		});
		...
		middle.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				DatabaseDealer.updateSettings(Set.this, "fontSize", "19");
			}
		});
		...
		big.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				DatabaseDealer.updateSettings(Set.this, "fontSize", "22");
			}
		});
	}
